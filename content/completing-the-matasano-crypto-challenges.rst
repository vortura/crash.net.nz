Completing the Matasano Crypto Challenges
#########################################
...
Back in April sometime, Maciej Cegłowski `posted on his blog`_ about some
cryptography challenges he'd been working through, run by the nice people at
Matasano security. `The challenges`_ are a set of practical exercises to build
...
.. _posted on his blog: https://blog.pinboard.in/2013/04/the_matasano_crypto_challenges/
.. _The challenges: http://www.matasano.com/articles/crypto-challenges/
...
A special mention too, for `ipython`_. I've used ipython a bit in the past,
mainly as a nicer version of the default Python interactive interpreter.
However, this was the first time I'd used the `ipython notebook format`_, and
...
.. _ipython notebook format: http://ipython.org/notebook.html
...
So, you should do the Matasano Crypto Challenges. You can sign up `here`_.
They're free, fun, and you're almost certain to learn something.

.. _here: http://www.matasano.com/articles/crypto-challenges/
